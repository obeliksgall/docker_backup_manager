...
const resources = {
  pl: {
    translation: {
      ...
      "stop_confirm_msg": "Czy na pewno chcesz wymusić natychmiastowe zatrzymanie tego zadania?",
      ...
      // ConfigModal (Eksport, Import, Ustawienia Ogólne i Retencja)
      "modal_config_title": "Zarządzanie Konfiguracją",
      "tab_settings": "Ustawienia",
      "tab_export": "Eksport (Kopia)",
      "tab_import": "Import (Przywróć)",
      "lbl_retention_days": "Czas retencji plików logów (dni)",
      "desc_retention_days": "Określa, po ilu dniach stare pliki logów zadań z katalogu logs/ są automatycznie usuwane podczas nocnej rotacji.",
      "btn_save_settings": "Zapisz ustawienia retencji",
      "days_unit": "dni",
      "msg_save_settings_success": "Pomyślnie zaktualizowano retencję logów na {{days}} dni.",
      "err_save_settings": "Nie udało się zapisać ustawień retencji.",
      
      "desc_export": "Pobierz zaszyfrowaną kopię zapasową pliku <1>config.json</1> oraz ustawień połączeń <3>rclone.conf</3>.",
      "lbl_export_password": "Hasło do zaszyfrowania pliku",
      "ph_export_password": "Wpisz bezpieczne hasło...",
      "btn_download_export": "Pobierz zaszyfrowany plik",

      "desc_import": "Wczytaj plik <1>.enc</1>, aby nadpisać aktualną konfigurację zadań i połączeń chmurowych.",
      ...
      "ph_import_password": "Wpisz hasło do pliku...",
  ...
  en: {
    translation: {
      ...
      "stop_confirm_msg": "Are you sure you want to forcefully terminate this running task?",
      ...
      "transfer_progress": "Real-time transfer progress",
      "scanning_files": "Scanning and verifying files...",

      // ConfigModal (Export, Import, General Settings & Log Retention)
      "modal_config_title": "Configuration Management",
      "tab_settings": "Settings",
      "tab_export": "Export (Backup)",
      "tab_import": "Import (Restore)",
      "lbl_retention_days": "Log files retention period (days)",
      "desc_retention_days": "Specifies after how many days old task log files in the logs/ directory are automatically removed during nightly rotation.",
      "btn_save_settings": "Save Retention Settings",
      "days_unit": "days",
      "msg_save_settings_success": "Log retention successfully updated to {{days}} days.",
      "err_save_settings": "Failed to save retention settings.",

      "desc_export": "Download an encrypted backup of the <1>config.json</1> file and remote connection settings <3>rclone.conf</3>.",
      "lbl_export_password": "Password to encrypt the file",
      "ph_export_password": "Enter a secure password...",
      "btn_download_export": "Download encrypted file",

      "desc_import": "Load a <1>.enc</1> file to overwrite the current task and cloud connection configuration.",
      ...
      "ph_import_password": "Enter the file password...",
      "btn_upload_import": "Decrypt and Restore",

      "btn_config_settings": "Settings Backup",
